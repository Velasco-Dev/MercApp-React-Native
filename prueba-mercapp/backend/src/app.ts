...
import { config, frontConfig } from "./config/app";
...
import { router as ventaRouter } from "./modules/venta/routes/venta.routes"; // Importar las rutas de inventario
